...
# from the point of view of positive and negative difference score correlations
# positive and negative correlations both indicate divergence or convergence
# just switch all parameters to women-men
...
plot.dat.A<-data.frame(
  ...
  type=rep(c("Mean for Men","Mean for Women","Difference = Women - Men"),each=n)
)
str(plot.dat.A)
...
ggplot2::ggsave(plot.comb,path = "illustrations",
                filename = "Figure_Divergence_Convergence_negative.png",
                device = "png",units = "cm",
                width = 21*(4/4),
...
plot.comb.red<-
  ggplot(plot.dat.comb[plot.dat.comb$type=="Difference = Women - Men",],
...
ggplot2::ggsave(plot.comb.red,path = "illustrations",
                filename = "Figure_Divergence_Convergence_negative_no_slopes.png",
                device = "png",units = "cm",
                width = 21*(4/4),
                height = 29.7/2,dpi = 300)
